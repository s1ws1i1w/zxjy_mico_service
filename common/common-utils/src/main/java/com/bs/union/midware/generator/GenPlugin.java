package com.bs.union.midware.generator;
...
public class GenPlugin extends PluginAdapter {
    ...
    public boolean clientGenerated(Interface interfaze, TopLevelClass topLevelClass, IntrospectedTable introspectedTable) {
        ...
        interfaze.addJavaDocLine(" * ");
        interfaze.addJavaDocLine(" * @author : zhuangruitao  1335877357@qq.com ");
        ...
        //引入com.hdyl.merchant.union.core.basis.BaseMapper
        interfaze.addImportedType(new FullyQualifiedJavaType("com.bs.union.model.base.deprecated.BaseMapper"));
        // 添加base接口 extends BaseMapper<User>
        interfaze.addSuperInterface(new FullyQualifiedJavaType("BaseMapper<" + introspectedTable.getBaseRecordType() + "," + typeName + ">"));
        // 添加@Mapper注解
    ...
    public boolean sqlMapDocumentGenerated(Document document, IntrospectedTable introspectedTable) {
        ...
        rootElement.addElement(new TextElement("\n  <!-- 查询记录是否存在 -->"));
        rootElement.addElement(createSelect("exist", tableName, modelName, pkColumn));
        rootElement.addElement(new TextElement("\n"));
    ...
    private XmlElement createPageSelect(String tableName, String modelName, IntrospectedTable introspectedTable) {
        ...
        StringBuilder selectStr = new StringBuilder();
        selectStr.append("select\n\t\t").append("<include refid=\"Base_Column_List\" />").append("\n\t").append("from ").append(tableName);
        /*select.addAttribute(new Attribute("parameterType", "cn.zhouyibin.utils.PageQuery"));*/
    ...
    public boolean modelBaseRecordClassGenerated(TopLevelClass topLevelClass, IntrospectedTable introspectedTable) {
        ...
        topLevelClass.addJavaDocLine(" * ");
        topLevelClass.addJavaDocLine(" * @author : zhouyibin   gralves@163.com");
